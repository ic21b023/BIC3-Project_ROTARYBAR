...
#define STM32_ACK "STM32-ACK -> "	/*!< Nachricht OK */
#define STM32_NACK "STM32-NACK -> " /*!< Nachricht falsch oder nicht erkannt */
#define NEW_LINE "\n\r"				/*!< Neue Zeile */
/**
  * @}
  */
...
static void SERIALPROT_COMMAND_CRS(SERIALPROTOCOL_TypeDef *hserialprot, uint8_t * TxBuffer );
static void SERIALPROT_COMMAND_CRG(SERIALPROTOCOL_TypeDef *hserialprot, uint8_t * TxBuffer );
static void SERIALPROT_COMMAND_CBS(SERIALPROTOCOL_TypeDef *hserialprot, uint8_t * TxBuffer );
static void SERIALPROT_COMMAND_CBG(SERIALPROTOCOL_TypeDef *hserialprot, uint8_t * TxBuffer );
/**
  * @}
  */
/* Exported functions --------------------------------------------------------*/
...
/**
  * @brief  Funktion 	Callback, welche in die main.c kopiert werden kann um die Eingabe des "crs" Befehls abzufragen
  * @param  hserialprot SERIALPROT handle
  * @retval query
  */
...
/**
  * @brief  Funktion 	Callback, welche in die main.c kopiert werden kann um die Eingabe des "crg" Befehls abzufragen
  * @param  hserialprot SERIALPROT handle
  * @retval query
  */
...
/**
  * @brief  Funktion 	Callback, welche in die main.c kopiert werden kann um die Eingabe des "cbs" Befehls abzufragen
  * @param  hserialprot SERIALPROT handle
  * @retval query
  */
...
/**
  * @brief  Funktion 	Callback, welche in die main.c kopiert werden kann um die Eingabe des "cbg" Befehls abzufragen
  * @param  hserialprot SERIALPROT handle
  * @retval query
  */
...
static void SERIALPROT_CreateMessage_TEXT_NUMBER(SERIALPROTOCOL_TypeDef *hserialprot,uint8_t * TxBuffer ){
	...
	if(__SERIALPROT_IS_COMMANDNAME(hserialprot,"asc")){
			SERIALPROT_COMMAND_ASC(hserialprot,TxBuffer);
	}else if (__SERIALPROT_IS_COMMANDNAME(hserialprot,"crs")){
			SERIALPROT_COMMAND_CRS(hserialprot,TxBuffer);
	}else if (__SERIALPROT_IS_COMMANDNAME(hserialprot,"crg")){
				SERIALPROT_COMMAND_CRG(hserialprot,TxBuffer);
	}else if (__SERIALPROT_IS_COMMANDNAME(hserialprot,"cbs")){
		SERIALPROT_COMMAND_CBS(hserialprot,TxBuffer);
	}else if (__SERIALPROT_IS_COMMANDNAME(hserialprot,"cbg")){
		SERIALPROT_COMMAND_CBG(hserialprot,TxBuffer);
	}else{
		wrong_message(TxBuffer);
	}
}
...
/**
  * @brief  Funktion 	wertet den Rückgabewert der "SERIALPROT_Command_CRS_Callback" aus und erzeugt dementsprechend die Antwort im TxBuffer
  * @param  hserialprot SERIALPROT handle
  * @param  TxBuffer 	Sendepuffer/Antwortpuffer
  * @retval none
  */
static void SERIALPROT_COMMAND_CRS(SERIALPROTOCOL_TypeDef *hserialprot, uint8_t * TxBuffer ){
	/* Erzeugen der Ausgangsnachricht falls Rückgabewerde der Callback 0 ist */
	if (!SERIALPROT_Command_CRS_Callback(hserialprot)){
		strcat(TxBuffer, NEW_LINE);
		strcat(TxBuffer, STM32_ACK);
		strcat(TxBuffer, CollectionBuffer);
...
/**
  * @brief  Funktion 	wertet den Rückgabewert der "SERIALPROT_Command_CRG_Callback" aus und erzeugt dementsprechend die Antwort im TxBuffer
  * @param  hserialprot SERIALPROT handle
  * @param  TxBuffer 	Sendepuffer/Antwortpuffer
  * @retval none
  */
static void SERIALPROT_COMMAND_CRG(SERIALPROTOCOL_TypeDef *hserialprot, uint8_t * TxBuffer ){
	/* Erzeugen der Ausgangsnachricht falls Rückgabewerde der Callback 0 ist */
	uint16_t retval = SERIALPROT_Command_CRG_Callback(hserialprot);
	//if (retval<0){
		strcat(TxBuffer, NEW_LINE);
		strcat(TxBuffer, STM32_ACK);
		strcat(TxBuffer, CollectionBuffer);
...
/**
  * @brief  Funktion 	wertet den Rückgabewert der "SERIALPROT_Command_CBS_Callback" aus und erzeugt dementsprechend die Antwort im TxBuffer
  * @param  hserialprot SERIALPROT handle
  * @param  TxBuffer 	Sendepuffer/Antwortpuffer
  * @retval none
  */
static void SERIALPROT_COMMAND_CBS(SERIALPROTOCOL_TypeDef *hserialprot, uint8_t * TxBuffer ){
	/* Erzeugen der Ausgangsnachricht falls Rückgabewerde der Callback 0 ist */
	if (!SERIALPROT_Command_CBS_Callback(hserialprot)){
		strcat(TxBuffer, NEW_LINE);
				strcat(TxBuffer, STM32_ACK);
				strcat(TxBuffer, CollectionBuffer);
				TxBuffer[strlen(TxBuffer)-1]=0;
...
/**
  * @brief  Funktion 	wertet den Rückgabewert der "SERIALPROT_Command_CBG_Callback" aus und erzeugt dementsprechend die Antwort im TxBuffer
  * @param  hserialprot SERIALPROT handle
  * @param  TxBuffer 	Sendepuffer/Antwortpuffer
  * @retval none
  */
static void SERIALPROT_COMMAND_CBG(SERIALPROTOCOL_TypeDef *hserialprot, uint8_t * TxBuffer ){
	/* Erzeugen der Ausgangsnachricht falls Rückgabewerde der Callback 0 ist */
	uint16_t retval = SERIALPROT_Command_CBG_Callback(hserialprot);
	//if (retval<0){
			strcat(TxBuffer, NEW_LINE);
			strcat(TxBuffer, STM32_ACK);
			strcat(TxBuffer, CollectionBuffer);
